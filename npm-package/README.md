...
> Android Termux package built from upstream OpenAI Codex `rust-v0.129.0`.
...
- Built from upstream `rust-v0.129.0`
...
- `exec`/code-mode is included through the packaged `codex-exec` binary
